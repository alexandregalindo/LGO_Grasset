...
const UserManagement = () => {
    ...
    const addUser = (data) => {
        ...
        axios.post('http://localhost:4081/api/user', formattedData)
            .then(response => {
    ...
    const editUser = (data) => {
        ...
        axios.put(`http://localhost:4081/api/user/${editingUser.Id}`, formattedData)
            .then(response => {
    ...
    const deleteUser = (userId) => {
        ...
        axios.delete(`http://localhost:4081/api/user/${userId}`)
            .then(response => {
                UserService.findAll().then(data => setUsers(data));
            })
            .catch(error => {
